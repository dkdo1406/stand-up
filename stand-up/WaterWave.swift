                ...
                HStack{
                    Button(action: { // 0보다 작거나
                        if currentwater<=0{
                            ...
                            currentwater-=Double(waterObject.start2_array[waterObject.start2])
                            percent = ((Double)(currentwater*100)/(waterObject.start1_array[waterObject.start1]*1000))
                        }
                    ...
                    Button(action: { //전체보다 크다
                        ...
                        currentwater+=Double(waterObject.start2_array[waterObject.start2]) //ml로 들어갔다.
                        percent = ((Double)(currentwater*100)/(waterObject.start1_array[waterObject.start1]*1000))
